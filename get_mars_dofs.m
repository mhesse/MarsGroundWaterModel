...
% Hellas
[dof.hellas,dof_f.hellas,X_f.hellas,Y_f.hellas] = get_feature_dofs(Grid,D,Xc,Yc,topo_contours.hellas);

% Argyre
[dof.argyre,dof_f.argyre,X_f.argyre,Y_f.argyre] = get_feature_dofs(Grid,D,Xc,Yc,topo_contours.argyre);
...
dof = Grid.dof(inpolygon(Xc(:),Yc(:),feature.x,feature.y));
